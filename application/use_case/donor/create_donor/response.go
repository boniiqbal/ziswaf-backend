...
type (
	CreateDonorResponse struct {
		base.BaseResponse
		Data CreateDonorResponseData `json:"data"`
	}

	CreateDonorResponseData struct {
		ID          uint64    `json:"id"`
...
func SetResponse(domain CreateDonorResponseData, message string, success bool) CreateDonorResponse {
	return CreateDonorResponse{
...
func ResponseMapper(domain domain.Donor) CreateDonorResponseData {
	return CreateDonorResponseData{
